Feature: Add Parameter :RAddParameter with g:ruby_refactoring_parentheses_style = 2
  ...
  Scenario: Add a parameter to a method defined with no parameters or parentheses
    ...
    And the variable g:ruby_refactoring_parentheses_style is set to 2
    When I go to the first line
    And I execute :RAddParameter
    And I fill in `foo`
    Then the result equals the file add_parameter-2
  ...
  Scenario: Add a parameter to a method defined with no parameters
    ...
    And I execute :RAddParameter
    And I fill in `foo`
    Then the result equals the file add_parameter_parentheses-2
  ...
  Scenario: Add a parameter to a method with an existing parameter
    ...
    And I execute :RAddParameter
    And I fill in `bar`
    Then the result equals the file add_parameter_parameter_parentheses-2
  ...
  Scenario: Add a parameter to a method with an existing parameter but not brackets
    ...
    And I execute :RAddParameter
    And I fill in `bar`
    Then the result equals the file add_parameter_parameter-2
  ...
  Scenario: Add a parameter to a method with two existing parameters
    ...
    And I execute :RAddParameter
    And I fill in `baz`
    Then the result equals the file add_parameter_2parameter_parentheses-2
  ...
  Scenario: Add a parameter to a method with two existing parameters but not brackets
    ...
    And I execute :RAddParameter
    And I fill in `baz`
    Then the result equals the file add_parameter_2parameter-2
