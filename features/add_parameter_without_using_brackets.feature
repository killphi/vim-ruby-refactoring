Feature: Add Parameter No Brackets :RAddParameterNB
  ...
  Scenario: Add a parameter to a method defined with no parameters but parentheses
    Given I have the following code:
    """
    def set_name()
    end
  ...
  Scenario: Add a parameter to a method with an existing parameter with parentheses
    Given I have the following code:
    """
    def set_details(name)
    end
